...
function PontoInicialBlocoB(){
    if ((i == B) && (f == A)); {
        alert("Siga pelo corredor para acessar a saída");
        alert("Vire a direita no calçamento e siga em frente");
        alert("Acesse o corredor do Bloco A a sua direita");
    }
    else if ((i == B) && (f == C)){
        alert("Siga pelo corredor para acessar a saída");
        alert("Vire a direita sentido a biblioteca");
